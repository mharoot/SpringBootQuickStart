...
<head>
  ...
  <script src="./assets/js/customScrollEvents.js"></script>
</head>
<body>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="./">Object Relational Mapper</a>
          <a class="dropdown-item" href="./query-builder.html">Query Builder</a>
        </div>
      </li>
    </ul>
  </div>
...
<p>The Elegant <code class=" language-php">all</code> method will return all of the results in the model's table. Since each Elegant model serves as a <a href="./query-builder.html">query builder</a>, you may also add constraints to queries, and then use the <code class=" language-php">get</code> method to retrieve the results:</p>
...
Since Elegant models are query builders, you should review all of the methods available on the <a href="./query-builder.html">query builder</a>. You may use any of these methods in your Elegant queries.</p>
